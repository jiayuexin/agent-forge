...
> **详细设计文档**: 参见 [TECH-DESIGN.md](./TECH-DESIGN.md)
> **架构全景图**: 参见 [TECH-DESIGN.md §2](./TECH-DESIGN.md#2-系统架构)（架构图以 Mermaid 格式内嵌）
...
| 文档 | 说明 |
|---|---|
| [01-核心设计.md](./01-核心设计.md) | IAgent 接口、数据模型、Pipeline 类型、调试台类型 |
...
| [TECH-DESIGN.md](./TECH-DESIGN.md) | 技术设计文档（详细实现方案） |
